...
public class EditProfile extends AppCompatActivity {
    ...
    String hasil_id_donatur;

    String Nama = "nama_donatur";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent i = getIntent();
        hasil_id_donatur = i.getStringExtra("id_donatur");
        TVusername.setText(i.getStringExtra("username"));
        ETnama.setText(i.getStringExtra("nama_donatur"));
        ...
        saveProfile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                GetImageNameFromEditText = hasil_id_donatur;
                UploadImageToServer();
        ...
        if (validate()) {
            ...
            class AsyncTaskUploadClass extends AsyncTask<Void, Void, String> {
                ...
                protected String doInBackground(Void... params) {
                    ...
                    HashMapParams.put(config.KEY_ID_DONATUR, hasil_id_donatur);
                    HashMapParams.put(ImageName, ConvertImage);
                    String FinalData = imageProcessClass.ImageHttpRequest(config.URL_UPLOAD_PP, HashMapParams);
