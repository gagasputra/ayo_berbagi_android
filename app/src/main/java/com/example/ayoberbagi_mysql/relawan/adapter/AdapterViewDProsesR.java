...
public class AdapterViewDProsesR extends RecyclerView.Adapter<AdapterViewDProsesR.ViewDProsesHolder> {
    Context context;
    private ArrayList<RelawanProsesModel> item;
    ImageLoader imageLoader;

    public AdapterViewDProsesR(Context context, ArrayList<RelawanProsesModel> item){
    ...
    public ViewDProsesHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_r_proses, parent, false);
