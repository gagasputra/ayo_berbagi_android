...
public class EditAkun extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.edit_akun_relawan);
        context = EditAkun.this;

        intent = getIntent();
        pref = new Preferences(getApplicationContext());
        relawanModel = pref.getRelawanSession();
        ...
        ETusername.setText(relawanModel.getUsername());
    }
        ...
        if (validate()) {
            StringRequest stringRequest = new StringRequest(Request.Method.POST, config.URL_EDIT_AKUN, new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    try {
                        ...
                        if (user.getString("hasil").equals("berhasil")) {
                            ...
                            Log.d("uname", uname);
                            pref.saveData(uname);
                            Intent i = new Intent(EditAkun.this, RelawanProfile.class);
                            startActivity(i);
                        } else {
                ...
                protected Map<String, String> getParams() throws AuthFailureError {
                    ...
                    params.put("id", relawanModel.getId());
